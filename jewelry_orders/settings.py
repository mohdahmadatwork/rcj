...
ENABLE_BACKGROUND_TASKS = config('ENABLE_BACKGROUND_TASKS', default=False, cast=bool)
ENABLE_WHATSAPP_TASKS = config('ENABLE_WHATSAPP_TASKS', default=False, cast=bool)
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = config('EMAIL_HOST_USER',default='royalcraftjewelers@gmail.com')
...
# Skip Redis if enabled (Tasks run synchronously)
